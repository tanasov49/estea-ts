    ...
    return (
        <aside className='aside-form'>
            ...
            <form onSubmit={hanldeSubmitForm} className="form-info" noValidate>
                <input className='form-info__input form-info__input_name' type="text" name='name' value={values.name} onChange={(e) => handleChange(e)} />
                <span className='form-info__error form-info__error_name'>{errors.name}</span>
                <input className='form-info__input form-info__input_email' type="email" name='email' value={values.email} onChange={(e) => handleChange(e)} />
                <span className='form-info__error form-info__error_email'>{errors.email}</span>
                <input className='form-info__input form-info__input_tel' type="tel" name='tel' value={values.tel} minLength={2} maxLength={11} onChange={(e) => handleChange(e)} />
