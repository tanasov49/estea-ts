import { IEvents, IProduct, ILinks} from "../interfaces/interfaces";
...
export const linksAbout:ILinks[] = [
...
export const menuFooter:ILinks[] = [
    {title: 'Om Estea', link: '#'},
    {title: 'Fonder', link: '#'},
    {title: 'Investera', link: '#'},
    {title: 'Medarbetare', link: '#'},
    {title: 'Press', link: '#'}
]
